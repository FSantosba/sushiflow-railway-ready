async function testRouting() {
  ...
  const payloadLegacy = {
    mesa: '99',
    itens: [
      { id: 'item-sim-esm-1', name: 'Budweiser Long Neck', price: 15, qty: 1 },
      { id: 'item-sim-esm-2', name: 'Temaki Salmão', price: 35, qty: 1 }
    ]
  };
  ...
  const payloadModern = {
    mesaId: '98',
    garcom: 'Teste Robo ESM',
    items: [
      { id: 'item-sim-esm-3', menuItemId: 'b-01', name: 'Coca Lata', price: 8, qty: 2 },
      { id: 'item-sim-esm-4', menuItemId: 'f-01', name: 'Sushi Combo', price: 60, qty: 1 }
    ]
  };
